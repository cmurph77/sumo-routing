...
if __name__ == "__main__":
    ...
    if network == 'tree_23_tl':     trips_array = [500,1000]
    ...
    for trip_count in trips_array:
        file1_name = alg1
        file1 = "out/"+alg1+"_out/"+network+"_output_files/"+type1+"_" + str(trip_count) + "tr.out.xml"
        file2_name = alg2
        file2 = "out/"+alg2+"_out/"+network+"_output_files/"+type2+"_" + str(trip_count) + "tr.out.xml"
